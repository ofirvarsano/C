 ...
 * @param _mode : Traversal mode - BSTREE_TRAVERSAL_PREORDER, BSTREE_TRAVERSAL_INORDER or BSTREE_TRAVERSAL_POSTORDER
 * @param _action : Action function to call for each element
 * @param _context : Context for the _action function
